...
texto.pack()
boton = ctk.CTkButton(frame, text="Aceptar", command=abrir_ventanatroll)
boton.pack(pady=20)
boton1 = ctk.CTkButton(frame, text="Continuar", command=abrir_ventana2)
boton1.pack(pady=20)
